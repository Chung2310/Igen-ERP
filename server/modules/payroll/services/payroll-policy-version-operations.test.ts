...
vi.mock("../models/payroll-policy.model", () => ({ PayrollPolicyModel: { find: mocks.find, findOne: mocks.findOne, findOneAndUpdate: mocks.findOneAndUpdate, updateOne: mocks.updateOne, create: mocks.create, deleteOne: mocks.deleteOne } }));
vi.mock("../models/payroll-run.model", () => ({ PayrollRunModel: { find: mocks.runFind } }));
vi.mock("../models/payroll-calculation-revision.model", () => ({ PayrollCalculationRevisionModel: { find: mocks.revisionFind } }));
