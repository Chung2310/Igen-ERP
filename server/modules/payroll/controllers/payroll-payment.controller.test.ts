...
vi.mock("../models/payroll-payment.model", () => ({
  PayrollPaymentModel: {
...
vi.mock("../services/payroll-transaction.service", () => ({
...
import { calculateEffectivePayrollChecksum } from "../services/payroll-effective-line.service";
import { projectPayrollRevisionWithOverrides } from "../services/payroll-run-calculate-operations.service";
...
describe("creating a payroll payment", () => {
  ...
  it("limits settlement against the pinned effective override net instead of the immutable system net", async () => {
    ...
    const { createPayrollEffectiveLineLoader } = await import("../services/payroll-effective-line.service");
